...
- **dekitayo** is a free personal milestone journal for parents, guardians, and adult caregivers.
- The app is **not a medical device** and does not provide medical advice, diagnosis, screening, or treatment.
- Milestone examples are adapted from publicly available CDC materials, but dekitayo is **not affiliated with or endorsed by the CDC**.
- Child profiles, milestone records, comments, and photos are **stored locally on your device** and are not sent to servers operated by us.
- Limited app analytics and crash information may be collected through third-party SDKs (TelemetryDeck, Firebase Analytics). See the Privacy Policy.
- You are responsible for backing up your data.
- These Terms include warranty disclaimers, limits on liability, and, **for U.S. users, an arbitration agreement and class action waiver** with a 30-day opt-out.

---

## 1. Acceptance of Terms

By downloading, installing, accessing, or using **dekitayo** (the "Service"), you agree to be bound by these Terms of Use ("Terms") and our [Privacy Policy](https://tacero51.github.io/dekitayo-legal/legal/privacy-en/). If you do not agree, you must not use the Service.
...
- **"We," "us," "our," or "Operator"**: The individual or entity operating the Service.
- **"You" or "User"**: Any person who downloads, installs, accesses, or uses the Service.
- **"Service"**: The dekitayo mobile application, including all features, content, and updates.
...
- Use any automated means to access or interact with the Service.
...
- Infringe on the intellectual property, privacy, publicity, or other rights of us or any third party;
- Use the Service to create, store, or manage unlawful, infringing, abusive, or otherwise objectionable content;
...
- The Service has **not** been evaluated, reviewed, or approved by the U.S. Food and Drug Administration ("FDA"), the Pharmaceuticals and Medical Devices Agency of Japan ("PMDA"), or any other regulatory authority.
- The developmental milestones shown in the Service are provided **for informational and personal record-keeping purposes only**.
- The Service is **not intended to diagnose, treat, cure, prevent, or screen for** any disease, disorder, developmental delay, or medical condition.
- The Service is **not a substitute** for professional medical advice, evaluation, or care.
- **No doctor-patient, provider-patient, or other healthcare professional relationship is created by your use of the Service.**
- **Do not disregard, avoid, or delay obtaining medical advice from a qualified healthcare professional because of information displayed in the Service.**
- **Always consult a qualified pediatrician, healthcare provider, or specialist** with any questions or concerns regarding your child's health or development.
- **In an emergency, call your local emergency number (e.g., 911 in the United States) immediately.**
...
**(a)** IN NO EVENT SHALL THE OPERATOR, ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR LICENSORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION LOSS OF PROFITS, REVENUE, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, ARISING OUT OF OR RELATED TO:
  ...
  (ii) ANY CONDUCT OR CONTENT OF ANY THIRD PARTY ON OR THROUGH THE SERVICE;
  (iii) ANY UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR DATA OR DEVICE;
  (iv) ANY DEVELOPMENTAL, MEDICAL, OR HEALTH OUTCOME OR DECISION INFORMED BY THE SERVICE;
  (v) ANY ERRORS, INACCURACIES, OR OMISSIONS IN THE SERVICE'S CONTENT.
...
(d) your violation of any third-party right, including any intellectual property or privacy right;
(e) any content you submit, post, or transmit through the Service.
...
You agree to comply with all applicable export and re-export control laws and regulations, including without limitation the U.S. Export Administration Regulations ("EAR") and the sanctions programs administered by the U.S. Office of Foreign Assets Control ("OFAC"). You represent and warrant that:
(a) you are not located in, under the control of, or a national or resident of any country embargoed by the U.S. government;
(b) you are not on any U.S. government list of restricted or prohibited persons;
(c) you will not use the Service in violation of any U.S. or other applicable export laws.
